...
- **UI:** [https://hostel-arising-unit-critics.trycloudflare.com](https://hostel-arising-unit-critics.trycloudflare.com)
- **API:** [https://ecological-scale-attachments-meter.trycloudflare.com](https://ecological-scale-attachments-meter.trycloudflare.com)
- **Agent:** [https://ecological-scale-attachments-meter.trycloudflare.com/api/agent](https://ecological-scale-attachments-meter.trycloudflare.com/api/agent)
...
export AGENT_URL="https://ecological-scale-attachments-meter.trycloudflare.com/api/agent"
export API_URL="https://ecological-scale-attachments-meter.trycloudflare.com"
```
...
export AGENT_URL="https://ecological-scale-attachments-meter.trycloudflare.com/api/agent"
export API_URL="https://ecological-scale-attachments-meter.trycloudflare.com"
export UI_URL="https://hostel-arising-unit-critics.trycloudflare.com"
...
```
UI:     https://hostel-arising-unit-critics.trycloudflare.com
API:    https://hostel-arising-unit-critics.trycloudflare.com
Agent:  https://ecological-scale-attachments-meter.trycloudflare.com/api/agent
