...
export AGENT_URL="https://walker-driving-crops-yale.trycloudflare.com/api/agent"
export API_URL="https://walker-driving-crops-yale.trycloudflare.com"
```
...
export AGENT_URL="https://walker-driving-crops-yale.trycloudflare.com/api/agent"
export API_URL="https://walker-driving-crops-yale.trycloudflare.com"
export UI_URL="https://jar-discover-compromise-step.trycloudflare.com"
...
```
UI:     https://jar-discover-compromise-step.trycloudflare.com
API:    https://jar-discover-compromise-step.trycloudflare.com
Agent:  https://walker-driving-crops-yale.trycloudflare.com/api/agent
