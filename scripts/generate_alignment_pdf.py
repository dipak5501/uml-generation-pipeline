#!/usr/bin/env python3
"""Generate a professor-facing thesis alignment PDF for the UML application."""
...
def add_footer(canvas, doc):
    ...
    canvas.drawString(
        0.75 * inch,
        0.4 * inch,
        "UML Multimodal Verification System — Thesis Alignment Report",
    )
...
def build():
    ...
    doc = SimpleDocTemplate(
        ...
        title="Thesis System Alignment Report",
        author="Dipak Yadav",
    )
    story = []

    story.append(Paragraph(
        "System Implementation Alignment Report",
        s["title"],
    ))
    story.append(Paragraph(
    ...
    story.append(Paragraph(
        ...
        "Document purpose: Demonstrate that the implemented program realizes the thesis methodology",
        s["meta"],
    ))

    story.append(Paragraph("1. Purpose of This Document", s["h1"]))
    story.append(Paragraph(
        "This report is prepared for faculty review. It explains how the software system "
            ...
            [
                ...
                [
                    ...
                    Paragraph(
                        ...
                        "Also supports <b>flowchart</b> (activity) diagrams in the demo app.",
                        s["small"],
                    ),
                ],
                [
                ...
                [
                    ...
                    Paragraph(
                        ...
                        "analytics distributions, demo dataset scripts (≥200 artifacts).",
                        s["small"],
                    ),
                ],
            ],
    ...
    story.append(Paragraph(
        "To make the methodology demonstrable for thesis review, the research pipeline was "
    ...
    story.append(
        bullets(
            [
                ...
                "<b>Provider abstraction</b> — OpenAI-compatible, Ollama, and mock mode for offline demos.",
    ...
    story.append(Paragraph(
        "The following checklist shows what a reviewer can observe in a live or recorded demo "
        "to confirm thesis alignment.",
        s["body"],
    ))
    story.append(
        table(
    ...
    story.append(Paragraph("<b>Local (recommended for advising meetings)</b>", s["h2"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph(
        "Default <font face='Courier'>MOCK_PROVIDERS=true</font> allows a complete demo without "
    ...
    story.append(Paragraph("<b>Suggested 5-minute faculty walkthrough</b>", s["h2"]))
    story.append(
        bullets(
            [
    ...
    story.append(Paragraph(
        ...
        "ui/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Streamlit thesis demo UI<br/>"
    ...
    story.append(Paragraph("9. Honesty Notes (Scope Boundaries)", s["h1"]))
    story.append(
        bullets(
            [
                ...
                "the app supports that mode and also an offline mock mode for reliable advising demos.",
    ...
    story.append(Paragraph(
        "The implemented system is not merely a collection of scripts: it is a runnable thesis "
        "demonstration of <i>Automated UML Dataset Generation from Natural-Language Requirements "
        ...
        "core while providing an advisor-friendly interface for inspection and grading discussions.",
        s["body"],
    ))
