...
**Live UI:** [https://chronicle-trained-ride-subscriptions.trycloudflare.com](https://chronicle-trained-ride-subscriptions.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://chronicle-trained-ride-subscriptions.trycloudflare.com |
| Public API (docs / exports) | https://trying-integer-converter-marking.trycloudflare.com |
| Remote command agent | https://trying-integer-converter-marking.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://trying-integer-converter-marking.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://trying-integer-converter-marking.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://trying-integer-converter-marking.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://trying-integer-converter-marking.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://trying-integer-converter-marking.trycloudflare.com/api/agent/command" \
