...
**Live UI:** [https://hostel-arising-unit-critics.trycloudflare.com](https://hostel-arising-unit-critics.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://hostel-arising-unit-critics.trycloudflare.com |
| Public API (docs / exports) | https://ecological-scale-attachments-meter.trycloudflare.com |
| Remote command agent | https://ecological-scale-attachments-meter.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://ecological-scale-attachments-meter.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://ecological-scale-attachments-meter.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://ecological-scale-attachments-meter.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://ecological-scale-attachments-meter.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://ecological-scale-attachments-meter.trycloudflare.com/api/agent/command" \
