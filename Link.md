...
**Live UI:** [https://feeds-phenomenon-console-diego.trycloudflare.com](https://feeds-phenomenon-console-diego.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://feeds-phenomenon-console-diego.trycloudflare.com |
| Public API (docs / exports) | https://privileges-andrew-applicants-smell.trycloudflare.com |
| Remote command agent | https://privileges-andrew-applicants-smell.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://privileges-andrew-applicants-smell.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://privileges-andrew-applicants-smell.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://privileges-andrew-applicants-smell.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://privileges-andrew-applicants-smell.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://privileges-andrew-applicants-smell.trycloudflare.com/api/agent/command" \
