...
**Live UI:** [https://starts-recognized-computed-spouse.trycloudflare.com](https://starts-recognized-computed-spouse.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://starts-recognized-computed-spouse.trycloudflare.com |
| Public API (docs / exports) | https://rid-arm-practice-knife.trycloudflare.com |
| Remote command agent | https://rid-arm-practice-knife.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://rid-arm-practice-knife.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://rid-arm-practice-knife.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://rid-arm-practice-knife.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://rid-arm-practice-knife.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://rid-arm-practice-knife.trycloudflare.com/api/agent/command" \
