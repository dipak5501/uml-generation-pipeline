...
**Live UI:** [https://nsw-intensity-president-sega.trycloudflare.com](https://nsw-intensity-president-sega.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://nsw-intensity-president-sega.trycloudflare.com |
| Public API (docs / exports) | https://cloudy-flows-creations-aviation.trycloudflare.com |
| Remote command agent | https://cloudy-flows-creations-aviation.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://cloudy-flows-creations-aviation.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://cloudy-flows-creations-aviation.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://cloudy-flows-creations-aviation.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://cloudy-flows-creations-aviation.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://cloudy-flows-creations-aviation.trycloudflare.com/api/agent/command" \
