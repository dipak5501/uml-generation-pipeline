...
**Live UI:** [https://outdoor-ascii-area-alternatives.trycloudflare.com](https://outdoor-ascii-area-alternatives.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://outdoor-ascii-area-alternatives.trycloudflare.com |
| Public API (docs / exports) | https://dependence-refurbished-efforts-earthquake.trycloudflare.com |
| Remote command agent | https://dependence-refurbished-efforts-earthquake.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://dependence-refurbished-efforts-earthquake.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://dependence-refurbished-efforts-earthquake.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://dependence-refurbished-efforts-earthquake.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://dependence-refurbished-efforts-earthquake.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://dependence-refurbished-efforts-earthquake.trycloudflare.com/api/agent/command" \
