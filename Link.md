...
**Live UI:** [https://recommendation-arizona-minimum-welding.trycloudflare.com](https://recommendation-arizona-minimum-welding.trycloudflare.com)
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://mariah-scored-top-stronger.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://mariah-scored-top-stronger.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://mariah-scored-top-stronger.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://mariah-scored-top-stronger.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://mariah-scored-top-stronger.trycloudflare.com/api/agent/command" \
