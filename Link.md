...
**Live UI:** [https://telephony-prayer-preview-sega.trycloudflare.com](https://telephony-prayer-preview-sega.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://telephony-prayer-preview-sega.trycloudflare.com |
| Public API (docs / exports) | https://aluminum-burke-transactions-speaker.trycloudflare.com |
| Remote command agent | https://aluminum-burke-transactions-speaker.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://aluminum-burke-transactions-speaker.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://aluminum-burke-transactions-speaker.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://aluminum-burke-transactions-speaker.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://aluminum-burke-transactions-speaker.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://aluminum-burke-transactions-speaker.trycloudflare.com/api/agent/command" \
