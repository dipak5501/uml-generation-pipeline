...
**Live UI:** [https://viewing-drives-psychological-mainly.trycloudflare.com](https://viewing-drives-psychological-mainly.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://viewing-drives-psychological-mainly.trycloudflare.com |
| Public API (docs / exports) | https://quarterly-crest-johnny-java.trycloudflare.com |
| Remote command agent | https://quarterly-crest-johnny-java.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://quarterly-crest-johnny-java.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://quarterly-crest-johnny-java.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://quarterly-crest-johnny-java.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://quarterly-crest-johnny-java.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://quarterly-crest-johnny-java.trycloudflare.com/api/agent/command" \
