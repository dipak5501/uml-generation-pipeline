...
**Live UI:** [https://soul-ignored-herself-accessing.trycloudflare.com](https://soul-ignored-herself-accessing.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://soul-ignored-herself-accessing.trycloudflare.com |
| Public API (docs / exports) | https://apparently-merit-merge-descriptions.trycloudflare.com |
| Remote command agent | https://apparently-merit-merge-descriptions.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://apparently-merit-merge-descriptions.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://apparently-merit-merge-descriptions.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://apparently-merit-merge-descriptions.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://apparently-merit-merge-descriptions.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://apparently-merit-merge-descriptions.trycloudflare.com/api/agent/command" \
