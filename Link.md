...
**Live UI:** [https://activation-famous-restaurant-cds.trycloudflare.com](https://activation-famous-restaurant-cds.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://activation-famous-restaurant-cds.trycloudflare.com |
| Public API (docs / exports) | https://captain-mountain-counted-meters.trycloudflare.com |
| Remote command agent | https://captain-mountain-counted-meters.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://captain-mountain-counted-meters.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://captain-mountain-counted-meters.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://captain-mountain-counted-meters.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://captain-mountain-counted-meters.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://captain-mountain-counted-meters.trycloudflare.com/api/agent/command" \
