...
**Live UI:** [https://suspended-dispatch-reporters-cole.trycloudflare.com](https://suspended-dispatch-reporters-cole.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://suspended-dispatch-reporters-cole.trycloudflare.com |
| Public API (docs / exports) | https://properly-collect-analysis-observed.trycloudflare.com |
| Remote command agent | https://properly-collect-analysis-observed.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://properly-collect-analysis-observed.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://properly-collect-analysis-observed.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://properly-collect-analysis-observed.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://properly-collect-analysis-observed.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://properly-collect-analysis-observed.trycloudflare.com/api/agent/command" \
