...
**Live UI:** [https://actually-continues-coupled-forward.trycloudflare.com](https://actually-continues-coupled-forward.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://actually-continues-coupled-forward.trycloudflare.com |
| Public API (docs / exports) | https://vertical-simplified-typical-arrange.trycloudflare.com |
| Remote command agent | https://vertical-simplified-typical-arrange.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://vertical-simplified-typical-arrange.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://vertical-simplified-typical-arrange.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://vertical-simplified-typical-arrange.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://vertical-simplified-typical-arrange.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://vertical-simplified-typical-arrange.trycloudflare.com/api/agent/command" \
