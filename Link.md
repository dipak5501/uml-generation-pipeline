...
**Live UI:** [https://let-eve-tapes-mixer.trycloudflare.com](https://let-eve-tapes-mixer.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://let-eve-tapes-mixer.trycloudflare.com |
| Public API (docs / exports) | https://bool-drunk-committed-introduction.trycloudflare.com |
| Remote command agent | https://bool-drunk-committed-introduction.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://bool-drunk-committed-introduction.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://bool-drunk-committed-introduction.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://bool-drunk-committed-introduction.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://bool-drunk-committed-introduction.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://bool-drunk-committed-introduction.trycloudflare.com/api/agent/command" \
