...
**Live UI:** [https://airfare-webmaster-ladder-poison.trycloudflare.com](https://airfare-webmaster-ladder-poison.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://airfare-webmaster-ladder-poison.trycloudflare.com |
| Public API (docs / exports) | https://budapest-lease-vision-tigers.trycloudflare.com |
| Remote command agent | https://budapest-lease-vision-tigers.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://budapest-lease-vision-tigers.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://budapest-lease-vision-tigers.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://budapest-lease-vision-tigers.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://budapest-lease-vision-tigers.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://budapest-lease-vision-tigers.trycloudflare.com/api/agent/command" \
