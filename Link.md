...
**Live UI:** [https://genre-meant-operate-mitchell.trycloudflare.com](https://genre-meant-operate-mitchell.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://genre-meant-operate-mitchell.trycloudflare.com |
| Public API (docs / exports) | https://winston-motor-sheriff-middle.trycloudflare.com |
| Remote command agent | https://winston-motor-sheriff-middle.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://winston-motor-sheriff-middle.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://winston-motor-sheriff-middle.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://winston-motor-sheriff-middle.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://winston-motor-sheriff-middle.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://winston-motor-sheriff-middle.trycloudflare.com/api/agent/command" \
