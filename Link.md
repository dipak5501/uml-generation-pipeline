...
**Live UI:** [https://comedy-trackback-pst-wells.trycloudflare.com](https://comedy-trackback-pst-wells.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://comedy-trackback-pst-wells.trycloudflare.com |
| Public API (docs / exports) | https://albums-soc-batman-tile.trycloudflare.com |
| Remote command agent | https://albums-soc-batman-tile.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://albums-soc-batman-tile.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://albums-soc-batman-tile.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://albums-soc-batman-tile.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://albums-soc-batman-tile.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://albums-soc-batman-tile.trycloudflare.com/api/agent/command" \
