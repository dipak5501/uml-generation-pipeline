...
**Live UI:** [https://implement-dated-appreciate-circus.trycloudflare.com](https://implement-dated-appreciate-circus.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://implement-dated-appreciate-circus.trycloudflare.com |
| Public API (docs / exports) | https://morrison-agriculture-announces-updated.trycloudflare.com |
| Remote command agent | https://morrison-agriculture-announces-updated.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://morrison-agriculture-announces-updated.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://morrison-agriculture-announces-updated.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://morrison-agriculture-announces-updated.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://morrison-agriculture-announces-updated.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://morrison-agriculture-announces-updated.trycloudflare.com/api/agent/command" \
