...
**Live UI:** [https://applicable-collectible-night-lane.trycloudflare.com](https://applicable-collectible-night-lane.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://applicable-collectible-night-lane.trycloudflare.com |
| Public API (docs / exports) | https://mysterious-gloves-stays-judges.trycloudflare.com |
| Remote command agent | https://mysterious-gloves-stays-judges.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://mysterious-gloves-stays-judges.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://mysterious-gloves-stays-judges.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://mysterious-gloves-stays-judges.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://mysterious-gloves-stays-judges.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://mysterious-gloves-stays-judges.trycloudflare.com/api/agent/command" \
