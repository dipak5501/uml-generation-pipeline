...
**Live UI:** [https://electric-cincinnati-organised-beans.trycloudflare.com](https://electric-cincinnati-organised-beans.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://electric-cincinnati-organised-beans.trycloudflare.com |
| Public API (docs / exports) | https://warnings-refresh-outer-corresponding.trycloudflare.com |
| Remote command agent | https://warnings-refresh-outer-corresponding.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://warnings-refresh-outer-corresponding.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://warnings-refresh-outer-corresponding.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://warnings-refresh-outer-corresponding.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://warnings-refresh-outer-corresponding.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://warnings-refresh-outer-corresponding.trycloudflare.com/api/agent/command" \
