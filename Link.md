...
**Live UI:** [https://apparel-para-destiny-alabama.trycloudflare.com](https://apparel-para-destiny-alabama.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://apparel-para-destiny-alabama.trycloudflare.com |
| Public API (docs / exports) | https://pretty-creating-neil-knowing.trycloudflare.com |
| Remote command agent | https://pretty-creating-neil-knowing.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://pretty-creating-neil-knowing.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://pretty-creating-neil-knowing.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://pretty-creating-neil-knowing.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://pretty-creating-neil-knowing.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://pretty-creating-neil-knowing.trycloudflare.com/api/agent/command" \
