...
**Live UI:** [https://application-perspectives-extreme-sender.trycloudflare.com](https://application-perspectives-extreme-sender.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://application-perspectives-extreme-sender.trycloudflare.com |
| Public API (docs / exports) | https://children-samples-selling-wisdom.trycloudflare.com |
| Remote command agent | https://children-samples-selling-wisdom.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://children-samples-selling-wisdom.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://children-samples-selling-wisdom.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://children-samples-selling-wisdom.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://children-samples-selling-wisdom.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://children-samples-selling-wisdom.trycloudflare.com/api/agent/command" \
