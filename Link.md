...
**Live UI:** [https://ash-territories-companion-devices.trycloudflare.com](https://ash-territories-companion-devices.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://ash-territories-companion-devices.trycloudflare.com |
| Public API (docs / exports) | https://behalf-pair-kinda-sao.trycloudflare.com |
| Remote command agent | https://behalf-pair-kinda-sao.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://behalf-pair-kinda-sao.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://behalf-pair-kinda-sao.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://behalf-pair-kinda-sao.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://behalf-pair-kinda-sao.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://behalf-pair-kinda-sao.trycloudflare.com/api/agent/command" \
