...
**Live UI:** [https://according-office-extensions-africa.trycloudflare.com](https://according-office-extensions-africa.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://according-office-extensions-africa.trycloudflare.com |
| Public API (docs / exports) | https://rpm-presence-revenue-contamination.trycloudflare.com |
| Remote command agent | https://rpm-presence-revenue-contamination.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://rpm-presence-revenue-contamination.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://rpm-presence-revenue-contamination.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://rpm-presence-revenue-contamination.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://rpm-presence-revenue-contamination.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://rpm-presence-revenue-contamination.trycloudflare.com/api/agent/command" \
