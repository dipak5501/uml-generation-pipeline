...
**Live UI:** [https://newark-cottage-nebraska-viewer.trycloudflare.com](https://newark-cottage-nebraska-viewer.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://newark-cottage-nebraska-viewer.trycloudflare.com |
| Public API (docs / exports) | https://ooo-walking-alaska-vote.trycloudflare.com |
| Remote command agent | https://ooo-walking-alaska-vote.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://ooo-walking-alaska-vote.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://ooo-walking-alaska-vote.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://ooo-walking-alaska-vote.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://ooo-walking-alaska-vote.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://ooo-walking-alaska-vote.trycloudflare.com/api/agent/command" \
