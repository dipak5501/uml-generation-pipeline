...
**Live UI:** [https://continuity-meanwhile-distributor-ahead.trycloudflare.com](https://continuity-meanwhile-distributor-ahead.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://continuity-meanwhile-distributor-ahead.trycloudflare.com |
| Public API (docs / exports) | https://carries-simpsons-namespace-offerings.trycloudflare.com |
| Remote command agent | https://carries-simpsons-namespace-offerings.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://carries-simpsons-namespace-offerings.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://carries-simpsons-namespace-offerings.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://carries-simpsons-namespace-offerings.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://carries-simpsons-namespace-offerings.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://carries-simpsons-namespace-offerings.trycloudflare.com/api/agent/command" \
