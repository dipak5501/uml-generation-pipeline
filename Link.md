...
**Live UI:** [https://evaluate-accessible-shakira-prostores.trycloudflare.com](https://evaluate-accessible-shakira-prostores.trycloudflare.com)

| Endpoint | URL |
|----------|-----|
| Public UI (browser, any network) | https://evaluate-accessible-shakira-prostores.trycloudflare.com |
| Public API (docs / exports) | https://texas-salary-repairs-infrared.trycloudflare.com |
| Remote command agent | https://texas-salary-repairs-infrared.trycloudflare.com/api/agent |
...
| Endpoint | URL |
|----------|-----|
| Agent health (open) | `https://texas-salary-repairs-infrared.trycloudflare.com/api/agent/health` |
| Submit command (auth) | `POST https://texas-salary-repairs-infrared.trycloudflare.com/api/agent/command` |
| Task status (auth) | `GET https://texas-salary-repairs-infrared.trycloudflare.com/api/agent/tasks/{task_id}` |
...
curl -s "https://texas-salary-repairs-infrared.trycloudflare.com/api/agent/health" | python3 -m json.tool
curl -s -X POST "https://texas-salary-repairs-infrared.trycloudflare.com/api/agent/command" \
