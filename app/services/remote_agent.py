...
def _execute_command(command: str, args: dict[str, Any]) -> tuple[dict[str, Any], str]:
    handlers: dict[str, Callable[[], tuple[dict[str, Any], str]]] = {
        ...
        "restart-tunnels": lambda: _script_result("scripts/start_public_tunnels.sh", 180),
        "publish-urls": lambda: _script_result("scripts/git_push_live_urls.sh", 180),
        "pull-main": lambda: _script_result("scripts/pull_main.sh", 120),
